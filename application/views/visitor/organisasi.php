...
<body>
    				...
    				<ul class="navbar-nav" style="margin-left:50px;">
      					<li class="nav-item">
								...
								<li class="nav-item active" style="padding-right:15px; padding-left:15px;">
										<a class="nav-link" href="<?= base_url();?>home/organisasi" style="color:green; font-family: 'Open Sans', sans-serif;">Organisasi</a>
								</li>
								<li class="nav-item" style="padding-right:15px; padding-left:15px;">
										<a class="nav-link page-scroll" href="<?= base_url();?>" style="font-family: 'Open Sans', sans-serif;">Tentang</a>
								</li>
								<li class="nav-item" style="padding-right:15px; padding-left:15px;">
	...
	<section class="berita" id="berita" style="background-color: rgba(204,209,209,0.3); min-height:439px;">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h2 class="mt-4 text-left">OOPS! THAT PAGE CAN'T BE FOUND.</h2>
				...
				<div class="wrapper">
					<a href="<?= base_url();?>" target=_blank class="btn btn-success" tabindex="-1" role="button" aria-disabled="true" align=center>Return Home</a><br><br>
				</div>
